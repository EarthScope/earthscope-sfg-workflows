...
`earthscope_sfg_workflows.data_mgmt.ports`
...
### `ArchiveSourcePort.authenticate(self, profile: 'str | None' = None) -> 'bool'`
...
### `ArchiveSourcePort.close(self) -> 'None'`

Release any held resources (tokens, connections).

### `ArchiveSourcePort.download_file(self, file_url: 'str', dest_path: 'Path') -> 'None'`
...
### `ArchiveSourcePort.list_files(self, directory_url: 'str') -> 'list[ArchiveFile]'`
...
### `AssetCatalogPort.add(self, asset: 'AssetEntry') -> 'AssetEntry'`
...
### `AssetCatalogPort.add_merge_job(self, parent_type: 'str', child_type: 'str', parent_ids: 'list[int] | list[str]') -> 'None'`
...
### `AssetCatalogPort.assets_for(self, kind: 'AssetKind | None' = None, *, network: 'str | None' = None, station: 'str | None' = None, campaign: 'str | None' = None) -> 'list[AssetEntry]'`
...
### `AssetCatalogPort.by_id(self, asset_id: 'int') -> 'AssetEntry | None'`
...
### `AssetCatalogPort.by_local_path(self, path: 'UPath') -> 'list[AssetEntry]'`
...
### `AssetCatalogPort.close(self) -> 'None'`

Release resources (DB connections, etc.).

### `AssetCatalogPort.count_by_kind(self, *, network: 'str | None' = None, station: 'str | None' = None, campaign: 'str | None' = None) -> 'dict[AssetKind, int]'`
...
### `AssetCatalogPort.delete(self, kind: 'AssetKind | None' = None, *, network: 'str | None' = None, station: 'str | None' = None, campaign: 'str | None' = None) -> 'int'`
...
### `AssetCatalogPort.delete_by_id(self, asset_id: 'int') -> 'bool'`
...
### `AssetCatalogPort.distinct_values(self, field: 'str', **filters: 'str | None') -> 'list[str]'`
...
### `AssetCatalogPort.is_merge_complete(self, parent_type: 'str', child_type: 'str', parent_ids: 'list[int] | list[str]') -> 'bool'`
...
### `AssetCatalogPort.mark_processed_bulk(self, asset_ids: 'list[int]') -> 'int'`
...
### `AssetCatalogPort.update(self, asset: 'AssetEntry') -> 'bool'`
...
### `FileStorePort.close(self) -> 'None'`

Release any held resources (connections, file handles).

### `FileStorePort.exists(self, path: 'UPath') -> 'bool'`
...
### `FileStorePort.get_remote(self, source: 'str', target: 'UPath') -> 'None'`
...
### `FileStorePort.get_size(self, path: 'UPath') -> 'int | None'`
...
### `FileStorePort.is_dir(self, path: 'UPath') -> 'bool'`
...
### `FileStorePort.is_file(self, path: 'UPath') -> 'bool'`
...
### `FileStorePort.list_files(self, directory: 'UPath', recursive: 'bool' = False) -> 'list[FileInfo]'`
...
### `FileStorePort.mkdir(self, path: 'UPath', parents: 'bool' = True) -> 'None'`
...
### `FileStorePort.put_remote(self, source: 'UPath', target: 'str') -> 'None'`
...
### `FileStorePort.remove(self, path: 'UPath') -> 'bool'`
