...
SUBMODULES = [
    ...
    "earthscope_sfg_workflows.config.workspace",
    "earthscope_sfg_workflows.data_mgmt",
    "earthscope_sfg_workflows.data_mgmt.utils",
    "earthscope_sfg_workflows.data_mgmt.assetcatalog",
    "earthscope_sfg_workflows.data_mgmt.assetcatalog.handler",
    "earthscope_sfg_workflows.data_mgmt.assetcatalog.schemas",
    "earthscope_sfg_workflows.data_mgmt.assetcatalog.tables",
    "earthscope_sfg_workflows.data_mgmt.directorymgmt",
    "earthscope_sfg_workflows.data_mgmt.directorymgmt.config",
    "earthscope_sfg_workflows.data_mgmt.directorymgmt.handler",
    "earthscope_sfg_workflows.data_mgmt.directorymgmt.schemas",
    "earthscope_sfg_workflows.data_mgmt.ingestion",
    "earthscope_sfg_workflows.data_mgmt.ingestion.archive_pull",
    "earthscope_sfg_workflows.data_mgmt.ingestion.config",
    "earthscope_sfg_workflows.data_mgmt.ingestion.datadiscovery",
    ...
    "earthscope_sfg_workflows.workflows.utils.protocols",
