"""Directory management for geodesy data processing.

Defines a hierarchical Pydantic model structure (network → station → campaign
→ data/results) and re-exports the schema types for clean imports.
